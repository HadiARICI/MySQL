...
--SOU3: isim'i buyuk harf kucuk harf gözetmeksizin 'A' ile baslayan tum bilgileri listeleyiniz
...
--SORU4: isim sutununu buyuk harflerle, soyisim sutununu kucuk harflerle listeleyiniz.select upper(isim) as isim_sutunu, lower(soyisim) as soyisim_sutunu from ornek;
