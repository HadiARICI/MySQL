...
delete from kursiyerler where sinav_notu=75; --Arif can silindi. yeniden eklene bilir
...
delete from kursiyerler where isim in('Derya Soylu','Yavuz Bal'); --2.yol
...
--Not default komut ile oluşturdumuz sutuna belietiğimiz veri tüm sütünlara işler.
